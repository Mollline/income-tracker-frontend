                        ...
                        <body className={styles.addRecordBody} style={{backgroundColor:"RGB(195,195,195)"}}>
                            <div style={{ display: 'flex', gap: '20px', margin: "20px", justifyContent: "center", alignItems: "center" }}>
                                ...
                                <div style={{ display: 'flex', gap: '5px', flexDirection: 'column', width: '396px', height: '444px' }}>
                                    ...
                                    <input style={{ width: "688px", height: '48px', border: '1px solid #D1D5DB', backgroundColor: '#F9FAFB', borderRadius: '5px',paddingLeft:'50px',color:'black' }} maxLength={20} type="text" name="noteTitle" value={formData.noteTitle} onChange={handleInputChange} />
                                    <label style={{ color: '#1F2937' }}>Advice:</label>
                                    <textarea style={{ width: "688px", height: '150px', border: '1px solid #D1D5DB', backgroundColor: '#F9FAFB', borderRadius: '5px', padding: "20px 50px", color:'black' }}  name="note" value={formData.note} onChange={handleInputChange} />
